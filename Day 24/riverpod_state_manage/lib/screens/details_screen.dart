...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<void> _loadDetails() async {
    ...
    final details = await movieController.getMovieDetails(widget.movie.id);
    if (details.isNotEmpty) {
      ...
      setState(() {
        _isLoadingDetails = false;
        _errorMessage = movieController.errorMessage.isNotEmpty
  ...
  Widget build(BuildContext context) {
    ...
    final isFavorite = favoriteController.isFavorite(widget.movie);
    final isWatchlisted = watchlistController.isInWatchlist(widget.movie);
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            child: _HeroPoster(posterUrl: widget.movie.poster),
          ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _MetaChip(
                          label: widget.movie.type.toUpperCase(),
                          color: AppColors.teal,
                          bgColor: AppColors.tealDim,
                        ),
                        const SizedBox(width: 8),
                        _MetaChip(
                          label: widget.movie.year.toString(),
                      ...
                      children: [
                        Expanded(
                          child: _ActionButton(
                            ...
                            onTap: () => setState(() {
                              favoriteController.toggleFavorite(widget.movie);
                            }),
                          ),
                        ),
                        ...
                        Expanded(
                          child: _ActionButton(
                            ...
                            onTap: () => setState(() {
                              watchlistController.toggleWatchlist(widget.movie);
                            }),
                          ),
                        ),
                      ],
  ...
  Widget _buildDetailsContent(BuildContext context) {
    final description = _details?['plot_overview'] ??
        _details?['description'] ??
        'No description available';
    final rating = _details?['user_rating'];
    final runtime = _details?['runtime_minutes'];
    final genres = _details?['genre_names'];
